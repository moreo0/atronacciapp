...
class _SearchPageState extends State<SearchPage> {
  ...
  late GetPostProvider _getPostProvider;
  ...
  void _onRefresh() async {
    await _getPostProvider.doGetPosts();
  ...
  void initState() {
    ...
    Future.delayed(Duration.zero, () {
      _getPostProvider = Provider.of<GetPostProvider>(context, listen: false);
      _getPostProvider.doGetPosts();
                ...
                child: Container(
                  ...
                  child: Row(
                    children: [
                      Expanded(
                        child: Padding(
                          ...
                          child: TextField(
                            ...
                            controller: searchC,
                            onChanged: (value) {
                              _getPostProvider.filterPosts(value);
                            },
                          ),
                        ),
                      ),
                      IconButton(
                        onPressed: () {
                          _getPostProvider.filterPosts(searchC.text);
                        },
                    ...
                    if (provider.filteredPosts.isEmpty) {
                      ...
                      return ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          var posts = provider.filteredPosts[index];
                          return Padding(
                                            ...
                                            builder: (BuildContext context) {
                                              return AlertDialog(
                                                title: const Text(
                                                    'Laporkan Postingan'),
                                                content: const Text(
                                                    'Kamu yakin ingin melaporkan postingan ini?'),
                                                actions: <Widget>[
                                                  TextButton(
